...
router.get('/getStudyCards', (req, res) => {
...
router.get('/getFlashcardData', (req, res) => {
...
router.get('/getFlashcardDataFilter', (req, res) => {
...
router.get('/getEngTranslation', (req, res) => {
